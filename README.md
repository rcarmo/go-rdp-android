...
4. **Security and release readiness**
   - Security mode and failed-auth backoff controls are now surfaced in Android UI; continue with CIDR/user allowlists plus TLS fingerprint/rotation controls.
