...
type summary struct {
	...
	RDPGFXProgressiveV2Selected   bool     `json:"rdpgfx_progressive_v2_selected,omitempty"`
	RDPGFXProgressiveV2Reason     string   `json:"rdpgfx_progressive_v2_reason,omitempty"`
	...
	RDPGFXProgressiveV2WriteCount int      `json:"rdpgfx_progressive_v2_write_count,omitempty"`
...
func main() {
	...
	s.RDPGFXProgressiveV2Selected = strings.Contains(sv, "rdpgfx_progressive_v2_selected")
	s.RDPGFXProgressiveV2Reason = lastTraceValue(sv, "rdpgfx_progressive_v2_selected", "reason")
	...
	s.RDPGFXProgressiveV2WriteCount = traceCountWithFieldValue(sv, "rdpgfx_frame_write", "path", "rdpgfx-progressive-v2")
	...
	if s.RDPGFXFrameStreamStopSeen && s.RDPGFXFrameStreamStopCount == 0 {
		s.RDPGFXFrameStreamStopCount = strings.Count(sv, "trace phase=rdpgfx_frame_stream_stop")
	}
