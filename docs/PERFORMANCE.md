...
- CI run `25986644703` keeps `/sec:rdp`, `/sec:tls`, and `/sec:nla` bitmap fallback gates passing and proves `/sec:nla /gfx` reaches active RDPGFX streaming (`rdpgfx_seen=true`, screenshot present, `exit_code=131`).
