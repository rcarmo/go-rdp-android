...
Current evidence commit: `4bb74ad` (`Cover AVC420 metadata layout`)
Latest referenced CI run: `26053911178` (`main` CI, success)
...
Latest checked artifact from CI run `26053911178`:
