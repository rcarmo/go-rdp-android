...
Current evidence commit: `0f1223e` (`Add Android first-run checklist`)
Latest referenced CI run: `25958493420` (`main` CI, success)
...
Latest checked artifact from CI run `25958493420`:
