...
Current evidence commit: `ba01f3b` (`Add Android settings help text`)
Latest referenced CI run: `25958151076` (`main` CI, success)
...
Latest checked artifact from CI run `25958151076`:
