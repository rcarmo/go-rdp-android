...
Current evidence commit: `3b3e7ab` (`Report bitmap RLE matrix savings`)
Latest referenced CI run: `26181238685` (`main` CI, success)
...
Latest checked artifact from CI run `26181238685`:
