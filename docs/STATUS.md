...
Current evidence commit: `822a91d` (`Refresh encoding matrix performance notes`)
Latest referenced CI run: `26149515575` (`main` CI, success)
...
Latest checked artifact from CI run `26149515575`:
