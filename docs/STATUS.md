...
Current evidence commit: `874f495` (`Add RDP client connection guidance`)
Latest referenced CI run: `25957507792` (`main` CI, success)
...
Latest checked artifact from CI run `25957507792`:
