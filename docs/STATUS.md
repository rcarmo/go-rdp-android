...
Current evidence commit: `107ee82` (`Refresh docs after accessibility touch cleanup`)
Latest referenced CI run: `25848274672` (`main` CI, success)
...
| CI diagnostic artifacts | Passing | Mock/probe, auth, FreeRDP, Android build, gomobile, and emulator/UX paths emit or preserve relevant mock-server/client logs, JSON/Markdown summaries, screenshots, and inspection artifacts where applicable. |
...
Latest checked artifact from CI run `25848274672`:
