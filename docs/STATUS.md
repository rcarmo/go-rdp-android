...
Current evidence commit: `f99eee0` (`Refresh status after auth artifact summary`)
Latest referenced CI run: `25780690569` (`main` CI, success)
...
Latest checked artifact from CI run `25780690569`:
