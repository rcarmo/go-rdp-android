...
Current evidence commit: `392882b` (`Refresh status after latest CI run`)
Latest referenced CI run: `26260716716` (`main` CI, success)
...
Latest checked artifact from CI run `26260716716`:
