...
Current evidence commit: `9c54e28` (`Parse bitmap codec capabilities`)
Latest referenced CI run: `26294722092` (`main` CI, success)
...
Latest checked artifact from CI run `26294722092`:
