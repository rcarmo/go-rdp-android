...
Current evidence commit: `8d8ec33` (`Encode RDPGFX frames with Planar codec`)
Latest referenced CI run: `25977026903` (`main` CI, success)
...
Latest checked artifact from CI run `25977026903`:
