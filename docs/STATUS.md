...
Current evidence commit: `75fc425` (`Fix soak summary mode line formatting`)
Latest referenced CI run: `25594247095` (`main` CI, success)
...
Latest checked artifact from CI run `25594247095`:
