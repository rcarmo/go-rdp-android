...
Current evidence commit: `137c03a` (`Expose copyable TLS fingerprint`)
Latest referenced CI run: `25956539798` (`main` CI, success)
...
Latest checked artifact from CI run `25956539798`:
