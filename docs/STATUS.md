...
| `drdynvc` scaffold | Unit/fuzz covered | Static `drdynvc`, DVC caps/create/data/data-first/close, RDPEI routing, fragment assembly, size bounds, fragment limits, stale-fragment cleanup, duplicate-create rejection, unexpected channel IDs, simultaneous fragments, close/reopen, and variable-length channel IDs. |
