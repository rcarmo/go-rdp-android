...
Current evidence commit: `e41c0b6` (`Refresh privacy graphics diagnostics`)
Latest referenced CI run: `26213710982` (`main` CI, success)
...
Latest checked artifact from CI run `26213710982`:
