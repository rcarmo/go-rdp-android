...
Current evidence commit: `edd1840` (`Emit experimental H264 over RDPGFX`)
Latest referenced CI run: `25995727584` (`main` CI, success)
...
Latest checked artifact from CI run `25995727584`:
