...
Current evidence commit: `0150dc2` (`Document release signing secret check`)
Latest referenced CI run: `25959487035` (`main` CI, success)
...
Latest checked artifact from CI run `25959487035`:
