...
Current evidence commit: `572d800` (`Refresh status after settings help`)
Latest referenced CI run: `25958293547` (`main` CI, success)
...
Latest checked artifact from CI run `25958293547`:
