...
Current evidence commit: `edcc751` (`Record coalesced H264 probe evidence`)
Latest referenced CI run: `26079295781` (`main` CI, success)
...
Latest checked artifact from CI run `26079295781`:
