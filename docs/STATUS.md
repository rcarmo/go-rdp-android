...
Current evidence commit: `06ccf61` (`Refresh status after README update`)
Latest referenced CI run: `25846637470` (`main` CI, success)
...
Latest checked artifact from CI run `25846637470`:
