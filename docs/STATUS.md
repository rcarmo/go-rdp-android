...
| Graphics | Functional baseline | 24-bit BGR slow-path bitmap tiles with dirty-tile suppression. Mobile frame submission plus bitmap tiling/scaling paths now reject invalid stride/data geometry and overflow cases before queueing, tiling, scaling, or allocating. Compression/RDPGFX/H.264 pending. |
