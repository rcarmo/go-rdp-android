...
Current evidence commit: `20f04ab` (`Refresh status after CI verification`)
Latest referenced CI run: `26258717211` (`main` CI, success)
...
Latest checked artifact from CI run `26258717211`:
