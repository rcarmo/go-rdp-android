...
Current evidence commit: `632df0e` (`Refresh status after green CI`)
Latest referenced CI run: `26257799975` (`main` CI, success)
...
Latest checked artifact from CI run `26257799975`:
