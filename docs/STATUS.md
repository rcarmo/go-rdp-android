...
Current evidence commit: `0441526` (`Refresh status after connection guidance`)
Latest referenced CI run: `25957662341` (`main` CI, success)
...
Latest checked artifact from CI run `25957662341`:
