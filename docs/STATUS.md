...
Current evidence commit: `1d3568f` (`Refresh status after latest policy CI`)
Latest referenced CI run: `25900645020` (`main` CI, success)
...
Latest checked artifact from CI run `25900645020`:
