...
Current evidence commit: `47e6fcc` (`Refresh status after soak evidence`)
Latest referenced CI run: `25959957452` (`main` CI, success)
...
Latest checked artifact from CI run `25959957452`:
