...
Current evidence commit: `87437b3` (`Refresh status after latest soak update`)
Latest referenced CI run: `25960250575` (`main` CI, success)
...
Latest checked artifact from CI run `25960250575`:
