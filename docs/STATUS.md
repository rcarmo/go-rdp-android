...
Current evidence commit: `ec088ea` (`Bound RDPEI dynamic channel buffers`)
Latest referenced CI run: `25363180319` (`main` CI, success)
...
| `drdynvc` scaffold | Unit/fuzz covered | Static `drdynvc`, DVC caps/create/data/data-first/close, RDPEI routing, fragment assembly, size bounds, fragment limits, stale-fragment cleanup, duplicate-create rejection, close/reopen, and variable-length channel IDs. |
...
Latest checked artifact from CI run `25363180319`:
