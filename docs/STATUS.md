...
Current evidence commit: `36d8d6e` (`Add bitmap encoder benchmarks`)
Latest referenced CI run: `25785649505` (`main` CI, success)
...
Latest checked artifact from CI run `25785649505`:
