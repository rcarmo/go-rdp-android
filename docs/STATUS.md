...
Current evidence commit: `c62f879` (`Document H264 write count evidence`)
Latest referenced CI run: `26026288646` (`main` CI, success)
...
Latest checked artifact from CI run `26026288646`:
