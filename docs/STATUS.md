...
Current evidence commit: `f282e1b` (`Refresh status after latest green CI`)
Latest referenced CI run: `25780982926` (`main` CI, success)
...
Latest checked artifact from CI run `25780982926`:
