...
Current evidence commit: `6834882` (`Check encoding matrix dependencies`)
Latest referenced CI run: `26146976439` (`main` CI, success)
...
Latest checked artifact from CI run `26146976439`:
