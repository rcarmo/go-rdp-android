...
Current evidence commit: `5697b8a` (`Refresh status after CI confirmation`)
Latest referenced CI run: `26261845921` (`main` CI, success)
...
Latest checked artifact from CI run `26261845921`:
