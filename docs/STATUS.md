...
Current evidence commit: `1f1e040` (`Normalize persisted failed-auth backoff`)
Latest referenced CI run: `25890580637` (`main` CI, success)
...
Latest checked artifact from CI run `25890580637`:
