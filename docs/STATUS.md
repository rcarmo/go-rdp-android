...
Current evidence commit: `5301bd8` (`Stabilize parser fuzz smoke`)
Latest referenced CI run: `26057766382` (`main` CI, success)
...
Latest checked artifact from CI run `26057766382`:
