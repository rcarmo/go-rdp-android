...
Current evidence commit: `75128fa` (`Summarize auth smoke artifacts`)
Latest referenced CI run: `25780420148` (`main` CI, success)
...
Latest checked artifact from CI run `25780420148`:
