...
Current evidence commit: `5cf4868` (`Record release preflight diagnostic result`)
Latest referenced CI run: `25986644703` (`main` CI, success)
...
Latest checked artifact from CI run `25986644703`:
