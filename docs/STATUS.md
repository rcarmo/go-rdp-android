...
Current evidence commit: `600a851` (`Refresh status after soak evidence`)
Latest referenced CI run: `26209949699` (`main` CI, success)
...
Latest checked artifact from CI run `26209949699`:
