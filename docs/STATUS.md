...
Current evidence commit: `e798ced` (`Expose bitmap RLE diagnostics`)
Latest referenced CI run: `26183324759` (`main` CI, success)
...
Latest checked artifact from CI run `26183324759`:
