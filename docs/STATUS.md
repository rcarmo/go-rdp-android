...
Current evidence commit: `0d707ee` (`Refresh status after trace docs`)
Latest referenced CI run: `26213161618` (`main` CI, success)
...
Latest checked artifact from CI run `26213161618`:
