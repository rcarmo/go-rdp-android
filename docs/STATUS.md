...
Current evidence commit: `a0d3809` (`Expose H264 encoded queue diagnostics`)
Latest referenced CI run: `25989493095` (`main` CI, success)
...
Latest checked artifact from CI run `25989493095`:
