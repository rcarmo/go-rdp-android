...
Current evidence commit: `1d88699` (`Bump GitHub Actions to Node 24-ready major versions`)
Latest referenced CI run: `25593625862` (`main` CI, success)
...
Latest checked artifact from CI run `25593625862`:
