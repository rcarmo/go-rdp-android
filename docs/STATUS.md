...
Current evidence commit: `e248b34` (`Refresh threat model diagnostics`)
Latest referenced CI run: `26214273155` (`main` CI, success)
...
Latest checked artifact from CI run `26214273155`:
