...
Current evidence commit: `daaf87a` (`Preserve RDPEI contact metadata`)
Latest referenced CI run: `25406380171` (`main` CI, success)
...
Latest checked artifact from CI run `25406380171`:
