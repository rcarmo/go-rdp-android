...
Current evidence commit: `ca3af20` (`Refresh status after soak status update`)
Latest referenced CI run: `25960101062` (`main` CI, success)
...
Latest checked artifact from CI run `25960101062`:
