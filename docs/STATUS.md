...
| Graphics | Functional baseline | 24-bit BGR slow-path bitmap tiles with dirty-tile suppression. Mobile frame submission plus bitmap tiling/scaling paths now reject invalid stride/data geometry and overflow cases before queueing, tiling, scaling, or allocating. Local 24-bit BGR tile encoder baselines cover 320x240, 1280x720, and 1920x1080 frames for repeatable before/after comparisons. Compression/RDPGFX/H.264 pending. |
