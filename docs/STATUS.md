...
Current evidence commit: `442ce9b` (`Harden frame scaling geometry validation`)
Latest referenced CI run: `25782185528` (`main` CI, success)
...
Latest checked artifact from CI run `25782185528`:
...
| Graphics | Functional baseline | 24-bit BGR slow-path bitmap tiles with dirty-tile suppression. Mobile frame submission plus bitmap tiling/scaling paths now reject invalid stride/data geometry and overflow cases before queueing, tiling, scaling, or allocating. Local benchmarks cover 320x240, 1280x720, and 1920x1080 24-bit BGR tile encoding for repeatable before/after comparisons. Compression/RDPGFX/H.264 pending. |
