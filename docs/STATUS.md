...
Current evidence commit: `af111ca` (`Refresh status after verified CI`)
Latest referenced CI run: `26258259484` (`main` CI, success)
...
Latest checked artifact from CI run `26258259484`:
