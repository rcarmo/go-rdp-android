...
Current evidence commit: `bd561ca` (`Expose DVC fragment health counter`)
Latest referenced CI run: `25752193172` (`main` CI, success)
...
Latest checked artifact from CI run `25752193172`:
