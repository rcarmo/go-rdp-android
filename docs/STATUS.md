...
Current evidence commit: `32b3a89` (`Refresh status after CI green`)
Latest referenced CI run: `26259941024` (`main` CI, success)
...
Latest checked artifact from CI run `26259941024`:
