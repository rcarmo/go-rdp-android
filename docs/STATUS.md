...
Current evidence commit: `6151ba6` (`Refresh status after CI pass`)
Latest referenced CI run: `26259142202` (`main` CI, success)
...
Latest checked artifact from CI run `26259142202`:
