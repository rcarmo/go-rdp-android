...
| Graphics | `bitmap_tile`, `bitmap_tile_skip`, `bitmap_rle_tile`, `bitmap_rle_solid`, `frame_resize`, `rdpgfx_caps_advertise`, `rdpgfx_cap`, `rdpgfx_caps_confirm`, `rdpgfx_pdu`, `rdpgfx_h264_status`, `rdpgfx_h264_write`, `rdpgfx_h264_stream_stop` | Bitmap fallback tile emission, dirty-tile suppression, opt-in bitmap RLE compressed-tile/solid fallback evidence, desktop-size scaling, RDPGFX capability/frame-channel evidence, and experimental AVC420/H.264 transport status/write/stop evidence. |
