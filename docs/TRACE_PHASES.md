...
| Graphics | `bitmap_tile`, `bitmap_tile_skip`, `bitmap_rle_tile`, `bitmap_rle_solid`, `nscodec_selected`, `nscodec_write`, `bitmap_codec_stream_stop`, `jpeg_codec_selected`, `jpeg_codec_write`, `frame_resize`, `rdpgfx_caps_advertise`, `rdpgfx_cap`, `rdpgfx_caps_confirm`, `rdpgfx_pdu`, `rdpgfx_frame_write`, `rdpgfx_h264_status`, `rdpgfx_h264_write`, `rdpgfx_h264_stream_stop`, `rdpgfx_uncompressed_selected`, `rdpgfx_frame_stream_stop` | Bitmap fallback tile emission, dirty-tile suppression, opt-in bitmap RLE compressed-tile/solid fallback evidence, opt-in NSCodec selection/build/write evidence, desktop-size scaling, RDPGFX capability/frame-channel evidence, and experimental AVC420/H.264 transport status/write/stop evidence. |
