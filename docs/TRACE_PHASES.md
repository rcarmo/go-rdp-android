...
| Activation / share data | `confirm_active`, `bitmap_codec_cap`, `share_data`, `share_data_write`, `frame_stream_stop` | Confirm Active capability summary, Bitmap Codecs capability entries, Share Data reads/writes, and streaming shutdown reason. |
...
| Graphics | `bitmap_tile`, `bitmap_tile_skip`, `bitmap_rle_tile`, `bitmap_rle_solid`, `nscodec_selected`, `nscodec_write`, `jpeg_codec_selected`, `jpeg_codec_write`, `png_codec_selected`, `png_codec_write`, `rfx_codec_selected`, `rfx_codec_write`, `bitmap_codec_stream_stop`, `frame_resize`, `rdpgfx_caps_advertise`, `rdpgfx_cap`, `rdpgfx_caps_confirm`, `rdpgfx_pdu`, `rdpgfx_frame_write`, `rdpgfx_h264_status`, `rdpgfx_h264_write`, `rdpgfx_h264_stream_stop`, `rdpgfx_uncompressed_selected`, `rdpgfx_frame_stream_stop`, `rdpgfx_clearcodec_selected`, `rdpgfx_progressive_selected`, `rdpgfx_avc444_selected`, `rdpgfx_avc444v2_selected` | Bitmap fallback tile emission, dirty-tile suppression, opt-in bitmap RLE compressed-tile/solid fallback evidence, opt-in SurfaceBits NSCodec/JPEG/PNG/RemoteFX selection/write evidence with `bytes`, `raw_bytes`, and `saved_bytes` fields for artifact raw/saved/percentage summaries, desktop-size scaling, RDPGFX capability/frame-channel evidence including fixture-hook path values (`rdpgfx-clearcodec`, `rdpgfx-progressive`, `rdpgfx-avc444`, `rdpgfx-avc444v2`), and experimental AVC420/H.264 transport status/write/stop evidence. |
